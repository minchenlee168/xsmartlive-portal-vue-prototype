...
const MOCK_LEVELS: MemberLevel[] = [
  {
    ...
    birthdayCouponAmount: null,
    birthdayCouponTiming: MEMBER_LEVEL_BIRTHDAY_COUPON_TIMING.BIRTH_MONTH,
  ...
  },
  {
    ...
    memberCount: 47,
    birthdayCouponEnabled: true,
    birthdayCouponAmount: 500,
    birthdayCouponTiming: MEMBER_LEVEL_BIRTHDAY_COUPON_TIMING.BIRTH_DAY,
    upgradePointsEnabled: true,
    upgradePoints: 500,
